...
pub struct ErrorMessage {
    pub error: LLRPStatus,
}

pub enum Message {
    GetSupportedVersion(GetSupportedVersion),
    GetSupportedVersionResponse(GetSupportedVersionResponse),
    ...
    AddRoSpec(AddRoSpec),
    AddRoSpecResponse(AddRoSpecResponse),
    DeleteRoSpec(DeleteRoSpec),
    DeleteRoSpecResponse(DeleteRoSpecResponse),
    StartRoSpec(StartRoSpec),
    StartRoSpecResponse(StartRoSpecResponse),
    StopRoSpec(StopRoSpec),
    StopRoSpecResponse(StopRoSpecResponse),
    EnableRoSpec(EnableRoSpec),
    EnableRoSpecResponse(EnableRoSpecResponse),
    DisableRoSpec(DisableRoSpec),
    DisableRoSpecResponse(DisableRoSpecResponse),
    GetRoSpecs(GetRoSpecs),
    GetRoSpecsResponse(GetRoSpecsResponse),
    AddAccessSpec(AddAccessSpec),
    AddAccessSpecResponse(AddAccessSpecResponse),
    DeleteAccessSpec(DeleteAccessSpec),
    DeleteAccessSpecResponse(DeleteAccessSpecResponse),
    EnableAccessSpec(EnableAccessSpec),
    EnableAccessSpecResponse(EnableAccessSpecResponse),
    DisableAccessSpec(DisableAccessSpec),
    DisableAccessSpecResponse(DisableAccessSpecResponse),
    GetAccessSpecs(GetAccessSpecs),
    GetAccessSpecsResponse(GetAccessSpecsResponse),
    ClientRequestOp(ClientRequestOp),
    ClientRequestOpResponse(ClientRequestOpResponse),
    GetReaderConfig(GetReaderConfig),
    GetReaderConfigResponse(GetReaderConfigResponse),
    SetReaderConfig(SetReaderConfig),
    SetReaderConfigResponse(SetReaderConfigResponse),
    ...
    EnableEventsAndReports(EnableEventsAndReports),
...
impl Message {
    pub fn id(&self) -> u16 {
        ...
        match self {
            ...
            Message::GetSupportedVersionResponse(m) => m.id(),
            Message::SetProtocolVersion(m) => m.id(),
            Message::SetProtocolVersionResponse(m) => m.id(),
            Message::GetReaderCapabilities(m) => m.id(),
            Message::GetReaderCapabilitiesResponse(m) => m.id(),
            Message::AddRoSpec(m) => m.id(),
            Message::AddRoSpecResponse(m) => m.id(),
            Message::DeleteRoSpec(m) => m.id(),
            Message::DeleteRoSpecResponse(m) => m.id(),
            Message::StartRoSpec(m) => m.id(),
            Message::StartRoSpecResponse(m) => m.id(),
            Message::StopRoSpec(m) => m.id(),
            Message::StopRoSpecResponse(m) => m.id(),
            Message::EnableRoSpec(m) => m.id(),
            Message::EnableRoSpecResponse(m) => m.id(),
            Message::DisableRoSpec(m) => m.id(),
            Message::DisableRoSpecResponse(m) => m.id(),
            Message::GetRoSpecs(m) => m.id(),
            Message::GetRoSpecsResponse(m) => m.id(),
            Message::AddAccessSpec(m) => m.id(),
            Message::AddAccessSpecResponse(m) => m.id(),
            Message::DeleteAccessSpec(m) => m.id(),
            Message::DeleteAccessSpecResponse(m) => m.id(),
            Message::EnableAccessSpec(m) => m.id(),
            Message::EnableAccessSpecResponse(m) => m.id(),
            Message::DisableAccessSpec(m) => m.id(),
            Message::DisableAccessSpecResponse(m) => m.id(),
            Message::GetAccessSpecs(m) => m.id(),
            Message::GetAccessSpecsResponse(m) => m.id(),
            Message::ClientRequestOp(m) => m.id(),
            Message::ClientRequestOpResponse(m) => m.id(),
            Message::GetReaderConfig(m) => m.id(),
            Message::GetReaderConfigResponse(m) => m.id(),
            Message::SetReaderConfig(m) => m.id(),
            Message::SetReaderConfigResponse(m) => m.id(),
            Message::CloseConnection(m) => m.id(),
            Message::CloseConnectionResponse(m) => m.id(),
            Message::GetReport(m) => m.id(),
            Message::RoAccessReport(m) => m.id(),
            Message::KeepAlive(m) => m.id(),
            Message::KeepAliveAck(m) => m.id(),
            Message::ReaderEventNotification(m) => m.id(),
            Message::EnableEventsAndReports(m) => m.id(),
            Message::CustomMessage(m) => m.id(),
            Message::ErrorMessage(m) => m.id(),
        }
    }
}